...
import { LayoutDashboard, BookOpen, Menu, X, LogOut, Users, DollarSign, Sparkles, MessageSquare, CalendarDays, Globe, GraduationCap, Building2 } from 'lucide-react';
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { to: ADMIN_ROUTES.EMPRESAS, icon: Building2, label: 'Inglés para Empresas' },
  ];
