        ...
        <div className="p-6 space-y-5">
          {sent ? (
            ...
            <>
              ...
              {/* Checkbox aceptación */}
              <label className={`flex items-start gap-3 cursor-pointer rounded-xl border-2 p-3 transition-all ${termsAccepted ? 'border-violet-400 bg-violet-50' : 'border-border hover:border-violet-300'}`}>
                <input
                  type="checkbox"
